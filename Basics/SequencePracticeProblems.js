...
let n1 = Math.floor(Math.random()*(90+1)+10);
let n2 = Math.floor(Math.random()*(90+1)+10);
let n3 = Math.floor(Math.random()*(90+1)+10);
let n4 = Math.floor(Math.random()*(90+1)+10);
let n5 = Math.floor(Math.random()*(90+1)+10);
...
console.log('Area of 2400sft in sqmts = ' + areaInsqMeters);
//Q5c
